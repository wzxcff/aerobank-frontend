import RedCard from "./cards/RedCard.tsx";

function RedCardHero() {
    return (
        <div className="flex flex-col items-center py-10 max-w-full border-gray-300 mx-15 mb-30 rounded-3xl text-base">
            <h1 className="flex justify-center text-lg">Card<span className="font-semibold">&nbsp; «Red»</span></h1>

            <div className="m-20">
                <div className="absolute w-80 h-48 bg-[#FF5353] blur-[100px] rounded-full"></div>
                <div className="text-white text-3xl font-bold relative"><RedCard/></div>
            </div>
